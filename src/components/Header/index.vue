    ...
    <div class="top">
      <div class="container">
        <div class="loginList">
          ...
          <p v-else>
            <a>{{ userName.name }}</a>
            <a class="register" href="javascript:void(0)" @click="logout"> 退出登录</a>
          </p>
        ...
        <div class="typeList">
          ...
          <a href="###">合作招商</a>
          <a href="###">商家后台</a>
          <button style="opacity: 0;" @click="logout">清除token</button>
...
export default {
  ...
  methods: {
    goSearch() {
      let query = this.$route.query || undefined
      this.$router.push({
        name: 'search',
        params: {
