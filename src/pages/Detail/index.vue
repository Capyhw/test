          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd v-for="item2 in item.spuSaleAttrValueList" :key="item2.id"
                    :class="{ active: item2.isChecked === 1 }"
                    @click="changeItem2(item2,item.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input v-model="skuNum" autocomplete="off" class="itxt" @input="rep">
                <a class="plus" href="javascript:" @click="addSkuNum">+</a>
                <a class="mins" href="javascript:" @click="reduceSkuNum">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    //设置选中样式
    changeItem2(item2, spuSaleAttrValueList) {
    ...
    rep(e) {
      this.skuNum = e.target.value.replace(/[^1-9]/g, '');
    },
    async addShopCar() {
      try {
