      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li v-for="(nav,index) in floorList.navList" :key="index" class="active">
        ...
        <div class="tab-pane">
          <div class="floor-1">
            ...
            <div class="floorBanner">
              <div id="floor2Swiper" ref="floor2Swiper" class="swiper-container">
                <div class="swiper-wrapper">
                  <div v-for="carousel in floorList.carouselList" :key="carousel.id" class="swiper-slide">
