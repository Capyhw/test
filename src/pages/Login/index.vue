          ...
          <div class="content">
            <form action="#">
              <div class="input-text clearFix">
                <span></span>
                <input v-model="phonenum" placeholder="邮箱/用户名/手机号" type="text">
              </div>
              <div class="input-text clearFix">
                <span class="pwd"></span>
  ...
  methods: {
    ...
    async userLogin() {
      try {
        ...
        await this.$store.dispatch("userLogin", {phone: phonenum, password});
        ...
        form {
          ...
          .input-text {
            ...
            span {
              ...
              background: url('~@/assets/images/home/icons.png') no-repeat -10px -201px;
              box-sizing: border-box;
